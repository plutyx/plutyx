...
try {
  ...
  // A sessão persistida é o contrato determinístico. Em runners lentos, a troca
  // Auth -> EmptyBusiness pode perder um ciclo visual mesmo depois do token existir.
  // Só recuperamos a UI quando a autenticação já concluiu; sem token, continua falha real.
