...
try{
  ...
  await component.getByText('400 g',{exact:true}).waitFor()
  await component.getByText('1.000 g',{exact:true}).waitFor()
  await component.getByText('600 g',{exact:true}).waitFor()
