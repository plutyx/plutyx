...
const suppliers={generated_at:'2026-09-06T22:00:00Z',summary:{suppliers_total:2,backup_suppliers:1,purchases_mapped:4,ingredients_covered:2},rows:[
...
const history=()=>({generated_at:'2026-09-06T19:15:00Z',rows:[
 ...(purchasePosted?[{id:102,ingredient_id:11,ingredient_name:'Frango',unit:'g',supplier_name:'Distribuidor A',quantity_milliunits:5000,total_cents:6000,freight_cents:500,tax_cents:0,landed_cents:6500,landed_per_1000_cents:1300,previous_landed_per_1000_cents:1160,change_bps:1207,created_at:'2026-09-06T19:15:00Z'}]:[]),
...
try{
 ...
 console.log('Compras 360 explicit-confirmation and supplier-link journey ok')
}catch(error){
