...
import { CashFlowVisualPortal } from "./cash-flow-v68";
import { CrmRelationshipOrbitPortal } from "./crm-orbit-v69";
...
function Root() {
  ...
  if (params.get("crm") === "1") return <OperatorRoute><><CrmLifecycleRoute /><CrmRelationshipOrbitPortal /></></OperatorRoute>;
  ...
  if (params.get("cash") === "1") return <OperatorRoute><><CashEngineRoute /><CashFlowVisualPortal /></></OperatorRoute>;
