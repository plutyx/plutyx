-- GCL v85: preserve historical AI contracts and enqueue new work under the
-- compact GCL-AI-2.3 refiner envelope.
...
begin
  ...
  values(p_audit_run_id,'canary',v_hash,'GCL-AI-2.3','nex-agi/nex-n2.5-mini:free','queued',now())
...
begin
  ...
  loop
    ...
    insert into sac.ai_enrichment_jobs(audit_run_id,purpose,evidence_hash,prompt_version,model_requested,status,updated_at)
    values(r.audit_run_id,'paid_analysis',v_hash,'GCL-AI-2.3','nex-agi/nex-n2.5-mini:free','queued',now())
